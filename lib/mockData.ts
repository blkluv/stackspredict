...
export const mockMarkets: Market[] = [
    ...
    },
    {
        ...
        description: 'Resolves YES if an official US presidential debate is held before March 1, 2026, as confirmed by the Associated Press.',
        liquidity: 95.2,
    },
    {
        id: '3',
        question: 'Will Ethereum pass 5,000 TPS with sharding by June 2026?',
        category: 'Crypto',
        yesPrice: 38,
        noPrice: 62,
        volume24h: 12.7,
    ...
    {
        id: '5',
        question: 'Will Apple announce a foldable iPhone by WWDC 2026?',
        category: 'Technology',
        yesPrice: 22,
        noPrice: 78,
        volume24h: 9.8,
    ...
    {
        id: '7',
        question: 'Will Stacks sBTC TVL exceed $1 Billion by Q2 2026?',
        category: 'Crypto',
        yesPrice: 58,
        noPrice: 42,
        volume24h: 19.4,
    ...
    {
        id: '8',
        question: 'Will global temperatures set a new record high in 2026?',
        category: 'Other',
        yesPrice: 71,
        noPrice: 29,
        volume24h: 5.3,
...
export const mockComments: Comment[] = [
    {
        ...
        marketId: '1',
        user: mockUsers[0],
        content: 'Bitcoin has broken through key resistance levels. The halving effect combined with institutional adoption makes $130K very likely by Q1.',
    ...
    },
    {
        ...
        marketId: '1',
        user: mockUsers[1],
        content: 'Macro conditions suggest otherwise. Fed policy and global economic uncertainty could keep BTC below $110K through Q1.',
